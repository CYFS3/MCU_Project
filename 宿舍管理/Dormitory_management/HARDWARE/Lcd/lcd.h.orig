...
#define SKYBLUE          0x7DFD //天蓝色
#define HUMICOLOR        0xFCB0 //湿度数据颜色
#define LIGHTCOLOR       0xF81F //粉色光强颜色
#define MQ2COLOR       	 0xC618 //灰色烟雾颜色
#define LIGHT_CYAN       0xE6FF //浅青色
#define HUISE       		 0x7BEF //深灰色
