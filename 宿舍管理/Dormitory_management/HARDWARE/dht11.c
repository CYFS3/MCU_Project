...
void DHT11_show(void)
{
    DHT11_REC_Data();
    /*温度*/
	LCD_ShowIntNum(5*32-8,0,rec_data[2],2,rec_data[2]<=28?SKYBLUE:ORANGE,BLACK,32);//data	
	/*湿度*/
	LCD_ShowIntNum(5*32-8,32,rec_data[0],2,HUMICOLOR,BLACK,32);//data  
...
void DHT11_REC_Data(void)
{
    ...
    rec_data[0] = RH == 0?rec_data[0]:RH;
    rec_data[1] = RL;
    rec_data[2] = TH == 0?rec_data[2]:TH;
    rec_data[3] = TL;
}
